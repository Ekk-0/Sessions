...
class __TwigTemplate_d659889684f1b2d85cd91734792a465d3e8370a056279d381781761dac3b1a7a extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/Users/eavosloo/Programming/PHP/Sessions/phpmyadmin/templates/database/export/index.twig");
    }
}

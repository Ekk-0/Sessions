...
class __TwigTemplate_3c3441f48e08e608227615eeade4686110097dfb1c3df6cc858fc24c6745d32f extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/Users/eavosloo/Programming/PHP/Sessions/phpmyadmin/templates/preferences/header.twig");
    }
}
